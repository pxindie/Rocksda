...
class screen{
  ...
  //    textAlign(CENTER);
  //    text("Çıkmak istediğinize emin misiniz?",width/2,height/2+75);
  //    if(mbut.buton("Geri Dön",height/2-100,stage == 0,handylist[2])){break;}
  //    if(mbut.buton("Geri Dön",height/2-200,stage == 1,handylist[2])){window="menu";}
  //  }
  //}
